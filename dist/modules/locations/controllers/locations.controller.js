...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all locations for the organization' }),
    ...
    (0, swagger_1.ApiQuery)({ name: 'search', required: false, type: String, example: 'Warehouse', description: 'Search by location name' }),
